        ...
        while not self._done:
            ...
            if self._bodies is not None: 
                for i in range(0, self._kinect.max_body_count):
                    ...
                    diff = sum([abs(points_avg - x) for x in listofnumbers])
                    ...
                    if i == 0:
                        ...
                        self._screen.blit(difflabel1, (300, 375))
                    if i == 1:
                        myfont = pygame.font.SysFont("monospace", 50)
                        difflabel2 = myfont.render(str(int(diff)), 1, (255 * normdiff, 255 * (1 - normdiff), 0))
                        self._screen.blit(difflabel2, (300, 375))
                    if i == 2:
                        myfont = pygame.font.SysFont("monospace", 50)
                        difflabel3 = myfont.render(str(int(diff)), 1, (255 * normdiff, 255 * (1 - normdiff), 0))
                        self._screen.blit(difflabel3, (300, 375))
                    if i == 3:
                        myfont = pygame.font.SysFont("monospace", 50)
                        difflabel4 = myfont.render(str(int(diff)), 1, (255 * normdiff, 255 * (1 - normdiff), 0))
                        self._screen.blit(difflabel4, (300, 375))
                    if i == 4:
                        myfont = pygame.font.SysFont("monospace", 50)
                        difflabel5 = myfont.render(str(int(diff)), 1, (255 * normdiff, 255 * (1 - normdiff), 0))
                        self._screen.blit(difflabel5, (300, 375))
                    if i == 5:
                        myfont = pygame.font.SysFont("monospace", 50)
                        difflabel6 = myfont.render(str(int(diff)), 1, (255 * normdiff, 255 * (1 - normdiff), 0))
                        self._screen.blit(difflabel6, (300, 375))
